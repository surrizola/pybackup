...
if multi:
   ...
   db = DB_NAME
   file_name = db + "-" + DATETIME + ".sql"
   dumpcmd = "mysqldump -u " + DB_USER + " -p" + DB_USER_PASSWORD + " " + db + " > " + TODAYBACKUPPATH + "/" + file_name
   os.system(dumpcmd)
   print "file dump in "+ TODAYBACKUPPATH + "/" + file_name
   pybackup.backupFile(file_name)
